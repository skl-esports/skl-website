...
function progression_enqueue_customizer_controls_styles() {
...
add_action( 'customize_controls_print_styles', 'progression_enqueue_customizer_controls_styles' );


//  See full blog post here
//  http://pluto.kiwi.nz/2014/07/how-to-add-a-color-control-with-alphaopacity-to-the-wordpress-theme-customizer/

function progression_add_customizer_custom_controls( $wp_customize ) {

    class Progression_Customize_Alpha_Color_Control extends WP_Customize_Control {
        ...
        public function render_content() { ?>
            <label>
                ...
                <input type="text" data-palette="<?php echo $this->palette; ?>" data-default-color="<?php echo $this->default; ?>" value="<?php echo intval( $this->value() ); ?>" class="progression-color-control" <?php $this->link(); ?>  />
            </label>
	 ...
	 */
	class Progression_Controls_Radio_Buttonset_Control extends WP_Customize_Control {
	 ...
	 */
	class Progression_Controls_Slider_Control extends WP_Customize_Control {
		...
		public function render_content() { ?>
			...
			<input type="number" class="progression-slider" id="input_<?php echo $this->id; ?>" value="<?php echo esc_attr( $this->value() ); ?>" step="<?php echo $this->choices['step']; ?>" <?php $this->link(); ?>/>
			
			
			<input type="text" class="progression-slider-hidden" id="input_<?php echo $this->id; ?>" value="<?php echo esc_attr( $this->value() ); ?>" step="<?php echo $this->choices['step']; ?>" <?php $this->link(); ?>/>
...
add_action( 'customize_register', 'progression_add_customizer_custom_controls' );
